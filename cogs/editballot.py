...
class MakeBallot(commands.Cog):
    ...
    async def editballot(self, ctx, chan, id: int):
        def check(m):
        ...
        embed.set_author(name=title.content,icon_url='https://cdn.discordapp.com/avatars/529855914669244417/3917b07936f26ab5835c103a92048901.jpg')
